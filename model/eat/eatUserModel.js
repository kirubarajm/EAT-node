...
Eatuser.get_eat_makeit_product_list_v_2_2= async function(req, result) {
            ...
            await Collection.list_all_active_collection_infinity_screen(req,async function(err,res3) {
              if (err) {
                ...
                let resobj = {
                  ...
                  empty_url:"https://eattovo.s3.amazonaws.com/upload/admin/makeit/1588685173321-No%20service%20screen-02.png",
                  empty_content:"EAT",
                  empty_subconent :"EAT",
                  result: kitchenlist
                };  
