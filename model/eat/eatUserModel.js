...
Eatuser.get_eat_kitchen_list_sort_filter_v_2_1_zone = async function (req,headers, result) {
  var userzoneid = '';
  var zoneName='';
            ...
            if (err) {
              ...
              //console.log("unservicablearray: ", unservicablearray.len);
                if(unservicablearray.length >0 ){
                  ...
                  Eatuser.get_eat_kitchen_list_sort_filter_v_2_1(req, headers,result);
                } 
            }
          });
        }else{
