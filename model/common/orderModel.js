            ...
            for(var j=0; j<res.length; j++){                
              if(datelist[z].date == res[j].date){
                if(res[j].user_experience == 0){
                  datelist[z].user_experience0 = res[j].order_count;                  
                }else if(res[j].user_experience == 1){
                  datelist[z].user_experience1 = res[j].order_count;
                }else if(res[j].user_experience == 2){
                  datelist[z].user_experience2 = res[j].order_count;
                }else if(res[j].user_experience == 3){
                  datelist[z].user_experience3 = res[j].order_count;
                }else if(res[j].user_experience == 4){
                  datelist[z].user_experience4 = res[j].order_count;
                }else if(res[j].user_experience == 5){
                  datelist[z].user_experience = res[j].order_count;
                }else{   }                
              }else{ }
            }        
          }
