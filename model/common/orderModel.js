    ...
    if (err) {
      ...
      if (res.length !== 0) {
        ...
        if (Orders_queue_details.length !==0) {
          ...
          await Notification.orderMoveItPushNotification(req.orderid,PushConstant.pageidMoveit_Order_unassign,await Notification.getMovieitDetail( res[0].moveit_user_id));
