...
Order.zone_level_performance_report= async function zone_level_performance_report(req,result) {   
  ...
  if (makeitmatrix.length !== 0) {
    let resobj = {
      success: true,
      status:true,
      makeitmetrix:makeitmetrix,
      moveitmetrix:moveitmetrix,
      ordermetrix:ordermetrix,
      kitchenshutdownmetrix:kitchenshutdownmetrix,
      logisticsshutdownmetrix:logisticsshutdownmetrix
    };
    result(null, resobj);
  }else {
    let resobj = {
