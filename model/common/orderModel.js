  ...
  sql.query(limitquery,async function(err, res1) {
    if (err) {
      ...
      for (let i = 0; i < res1.length; i++) {
        ...
        if (res1[i].orderstatus===6 || res1[i].orderstatus===7) {
