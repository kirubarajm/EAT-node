...
////////Movit Report
app.route("/admin/moveit/moveitordersdeliveryreport").post(routesVersioning({"1.0.0":moveituser.firstmile_userwise_moveitreport}));
...
app.route("/admin/moveit/milebasedmoveitaveragedeliveryreport").post(routesVersioning({"1.0.0":moveituser.orderwise_moveitreport}));
}